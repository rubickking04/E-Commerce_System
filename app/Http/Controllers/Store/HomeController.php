...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $last_year = Order::where('store_id', Auth::id())->whereYear('created_at', date('Y', strtotime('-1 year')))->get(['created_at','total_price'])->sum('total_price');
        $products = Product::where('store_id',Auth::id())->latest()->take(7)->get();
        $orders = Order::where('store_id',Auth::id())->latest()->take(7)->get();
        // dd($last_year);
