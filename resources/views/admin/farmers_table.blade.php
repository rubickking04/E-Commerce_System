                            ...
                            <div class="col-lg-11 col-12">
                                <div class="row border-bottom border-2 border-primary">
                                    <div class="col-lg-8 col-md-7 col-sm-6 col-6 d-none d-sm-block">
                                        <div class="text-start py-3 fs-4 fw-bold card-title">{{ __('Farmers Table') }}
                                        </div>
                                    </div>
                                                    ...
                                                    <table class="table table-bordered">
                                                        <thead class="table-primary">
                                                            <tr class="text-center">
                                                                <th scope="col">{{ __(' ') }}</th>
                                                                <th scope="col">{{ __('Farmers Name') }}</th>
                                                            ...
                                                            @foreach ($user as $users)
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center" scope="row">
                                                                        ...
                                                                        <a href="{{ route('admin.farmers.delete', $users->id) }}" class="btn btn-danger" onclick="return confirm('Are you sure to remove this user?')">
