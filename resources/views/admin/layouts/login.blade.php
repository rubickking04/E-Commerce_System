    ...
    <div id="app">
        <nav class="navbar navbar-expand bg-light shadow-lg">
            <div class="container">
                ...
                {{-- <p class="navbar-brand mb-0 navbar-text fw-bold text-dark text-end">{{ __('Administrators Login') }}</p> --}}
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item px-2 mx-auto">
                        <a class="nav-link d-none d-sm-block" href="#">{{ __('Administrator Login') }}</a>
                    </li>
                </ul>
            </div>
        </nav>
